...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            ...
            work_dirs/internlm2_chat_7b_lora_huatuo_e3/epoch_3_hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/internlm2_chat_7b_lora_huatuo_e3/hf \
            work_dirs/internlm2_chat_7b_lora_huatuo_e3/merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/internlm2-chat-1_8b \
            --adapter work_dirs/internlm2_chat_7b_lora_huatuo_e3/hf \
