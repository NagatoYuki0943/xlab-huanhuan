...
train:
    ...
    ex:
        xtuner train train/internlm2_chat_1_8b_qlora_huanhuan_e3.py --deepspeed deepspeed_zero2
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/internlm2_chat_1_8b_qlora_huanhuan_e3.py
"""
