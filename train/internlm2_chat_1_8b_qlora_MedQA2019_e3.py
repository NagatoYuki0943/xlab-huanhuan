...
train:
    ...
    ex:
        xtuner train train/internlm2_chat_1_8b_qlora_MedQA2019_e3.py --deepspeed deepspeed_zero2
...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            ...
            work_dirs/internlm2_chat_1_8b_qlora_MedQA2019_e3/epoch_3.hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/internlm2_chat_1_8b_qlora_MedQA2019_e3/epoch_3.hf \
            work_dirs/internlm2_chat_1_8b_qlora_MedQA2019_e3/epoch_3.merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/internlm2-chat-1_8b \
            --adapter work_dirs/internlm2_chat_1_8b_qlora_MedQA2019_e3/epoch_3.hf \
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/internlm2_chat_1_8b_qlora_MedQA2019_e3.py
"""
...
# Data
data_path = './data/MedQA/MedQA2019-structured.jsonl'
...
evaluation_freq = 10
SYSTEM = 'You are a professional, highly experienced doctor professor. You always provide accurate, comprehensive, and detailed answers based on the patients'
evaluation_inputs = [
    'what does memantine look like',
    'what happens if your child ate a tylenol tablet'
]
