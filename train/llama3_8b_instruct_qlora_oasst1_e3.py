...
train:
    ...
    ex:
        xtuner train train/llama3_8b_instruct_qlora_oasst1_e3.py --deepspeed deepspeed_zero2
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/llama3_8b_instruct_qlora_oasst1_e3.py
"""
