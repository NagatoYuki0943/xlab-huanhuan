...
train:
    ...
    ex:
        xtuner train train/internlm2_chat_1_8b_qlora_moss_e3.py --deepspeed deepspeed_zero2
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/internlm2_chat_1_8b_qlora_moss_e3/hf \
            work_dirs/internlm2_chat_1_8b_qlora_moss_e3/merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/internlm2-chat-1_8b \
            --adapter work_dirs/internlm2_chat_1_8b_qlora_moss_e3/hf \
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/internlm2_chat_1_8b_qlora_moss_e3.py
"""
...
moss_sft_no_plugins_path = './data/moss-003-sft-data/raw/moss-003-sft-no-tools.jsonl'
moss_sft_plugins_path = './data/moss-003-sft-data/raw/conversations_with_tools_with_inner_instruction_no_text2image_train_all_random_meta0.5_0.1_0.01_moss_0709.jsonl'
max_length = 2048
