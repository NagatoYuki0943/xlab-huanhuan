...
train:
    ...
    ex:
        xtuner train train/llama3_8b_instruct_lora_huatuo_e3.py --deepspeed deepspeed_zero2
...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            train/llama3_8b_instruct_lora_huatuo_e3.py \
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3.pth \
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3_hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/hf \
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/internlm2-chat-1_8b \
            --adapter work_dirs/llama3_8b_instruct_lora_huatuo_e3/hf \
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/llama3_8b_instruct_lora_huatuo_e3.py
"""
