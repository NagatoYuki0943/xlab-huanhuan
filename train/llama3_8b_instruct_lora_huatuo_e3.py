...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            ...
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3.hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3.hf \
            work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3.merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/models/Meta-Llama-3-8B-Instruct \
            --adapter work_dirs/llama3_8b_instruct_lora_huatuo_e3/epoch_3.hf \
