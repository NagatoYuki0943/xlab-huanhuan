...
train:
    ...
    ex:
        xtuner train train/internlm2_1_8b_qlora_recipe_e3.py --deepspeed deepspeed_zero2
...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            train/internlm2_1_8b_qlora_recipe_e3.py \
            work_dirs/internlm2_1_8b_qlora_recipe_e3/iter_431000.pth \
            work_dirs/internlm2_1_8b_qlora_recipe_e3/hf
...
merge adapter
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/internlm2_1_8b_qlora_recipe_e3/hf \
            work_dirs/internlm2_1_8b_qlora_recipe_e3/merged \
            --max-shard-size 2GB
"""
...
#                          PART 1  Settings                           #
#######################################################################
data_path = './data/recipe_dataset-single_xtuner.json'
model_dir = './models/internlm2-chat-1_8b-sft'
work_dir = './work_dirs/internlm2_1_8b_qlora_recipe_e3'
