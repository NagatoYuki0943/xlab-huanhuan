...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            ...
            work_dirs/internlm2_5-1_8b-chat_qlora_huatuo_e1/iter_2708_hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            ...
            work_dirs/internlm2_5-1_8b-chat_qlora_huatuo_e1/iter_2708_hf \
            work_dirs/internlm2_5-1_8b-chat_qlora_huatuo_e1/iter_2708_merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/internlm2_5-1_8b-chat \
            --adapter work_dirs/internlm2_5-1_8b-chat_qlora_huatuo_e1/iter_2708_hf \
...
train_dataset3 = dict(
    type=process_hf_dataset,
    dataset=dict(type=load_dataset, path="json", data_files=dict(train=data_path3)),
    tokenizer=tokenizer,
    max_length=max_length,
...
train_dataset = dict(
    type=ConcatDataset, datasets=[train_dataset1, train_dataset2, train_dataset3]
)
