...
train:
    ...
    ex:
        xtuner train train/internvl_v2_internlm2_2b_qlora_finetune_e1.py --deepspeed deepspeed_zero2
...
convert:
    ...
    ex:
        xtuner convert pth_to_hf \
            train/internvl_v2_internlm2_2b_qlora_finetune_e1.py \
            work_dirs/internvl_v2_internlm2_2b_qlora_finetune_e1/epoch_1.pth \
            work_dirs/internvl_v2_internlm2_2b_qlora_finetune_e1/epoch_1.hf \
            --max-shard-size 2GB
...
merge adapter:
    ...
    ex:
        xtuner convert merge \
            models/InternVL2-2B \
            work_dirs/internvl_v2_internlm2_2b_qlora_finetune_e1/epoch_1.hf \
            work_dirs/internvl_v2_internlm2_2b_qlora_finetune_e1/epoch_1_merged \
            --max-shard-size 2GB
...
chat:
    ...
    ex:
        xtuner chat \
            models/InternVL2-2B \
            --adapter work_dirs/internvl_v2_internlm2_2b_qlora_finetune_e1/epoch_1.hf \
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/internvl_v2_internlm2_2b_qlora_finetune_e1.py
"""
