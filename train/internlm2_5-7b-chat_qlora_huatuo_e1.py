...
train:
    ...
    ex:
        xtuner train train/internlm2_5-7b-chat_qlora_huatuo_e1.py --deepspeed deepspeed_zero2
...
验证数据集是否正确构建:
    ...
    ex:
        xtuner check-custom-dataset train/internlm2_5-7b-chat_qlora_huatuo_e1.py
"""
